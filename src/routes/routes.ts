...
import { atualizarPet, atualizarTutor, criarPet, deletarPet, deletarTutor, mostrarTutors} from '../controller/controller'

import { criarTutor } from '../service/tutorService'
